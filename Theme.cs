...
namespace teacher_evaluation_project {
    ...
    public class Theme {
        ...
        public static string activeFont;
        ...
        List<Palette> themeList = new List<Palette>()
        {
            ...
            {new Palette(Color.FromArgb(70, 70, 70), Color.FromArgb(71, 115, 130), Color.FromArgb(30, 100, 120), Color.FromArgb(40, 90, 90), Color.Gainsboro, Color.White)},
        };

        public Theme() {
            textSize = 10;
            activeFont = "Microsoft Sans Serif";
            themeIndex = 0;
